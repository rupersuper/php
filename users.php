                    ...
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $user['name']; ?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?php switch ($user['status']) {
                                                                case 'online':
                                                                    echo 'success';
                                                                    break;
                                                                case 'away':
                                ...
                                <div class="info-card-text flex-1">
                                    <a href="/page_profile.php?id=<?php echo $user['id']; ?>" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        <?php echo $user['name']; ?>
                                    ...
                                    <?php if (is_admin(get_authenticated_user()) || is_equal($user, get_authenticated_user())) : ?>
                                        <div class="dropdown-menu">
                                            ...
                                            <a href="/actions/delete.php?id=<?php echo $user['id']; ?>" class="dropdown-item" onclick="return confirm('are you sure?');">
